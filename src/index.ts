...
cron.schedule("*/30 * * * *", async () => {
  ...
  const result = await text_model.generateContent(
    "generate a message to kindly as the user if he/she still there , give directly the message do not use any variable and do not take part fo the answer , do not use quotes"
  );
